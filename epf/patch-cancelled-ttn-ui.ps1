...
# 1. UTM /opt/out must be requested without forcing Accept: application/xml.
...
# 2. Add explicit UTM and TTN selection procedures once.
...
# 3. If a TTN was explicitly selected, correction buttons operate only on it.
...
# 4. Add form attributes and commands/buttons if they are not present.
...
if ($f -notmatch 'Command name="ВыбратьУТМ"') {
    $buttons = '      <Button name="ВыбратьУТМ" id="4"><Type>UsualButton</Type><Title><v8:item><v8:lang>ru</v8:lang><v8:content>Выбрать УТМ</v8:content></v8:item></Title><CommandName>Form.Command.ВыбратьУТМ</CommandName></Button>' + [Environment]::NewLine +
               '      <Button name="ПроверитьУТМ" id="5"><Type>UsualButton</Type><Title><v8:item><v8:lang>ru</v8:lang><v8:content>Проверить УТМ</v8:content></v8:item></Title><CommandName>Form.Command.ПроверитьУТМ</CommandName></Button>' + [Environment]::NewLine +
               '      <Button name="ВыбратьТТН" id="6"><Type>UsualButton</Type><Title><v8:item><v8:lang>ru</v8:lang><v8:content>Выбрать ТТН</v8:content></v8:item></Title><CommandName>Form.Command.ВыбратьТТН</CommandName></Button>' + [Environment]::NewLine
    $needle = '      <Button name="Получить" id="5">'
    $f = $f.Replace($needle, $buttons + $needle)
}
if ($f -notmatch 'Command name="ВыбратьУТМ"') {
    $commands = '    <Command name="ВыбратьУТМ" id="5"><Title><v8:item><v8:lang>ru</v8:lang><v8:content>Выбрать УТМ</v8:content></v8:item></Title><Action>ВыбратьУТМ</Action><CurrentRowUse>DontUse</CurrentRowUse></Command>' + [Environment]::NewLine +
                '    <Command name="ПроверитьУТМ" id="6"><Title><v8:item><v8:lang>ru</v8:lang><v8:content>Проверить УТМ</v8:content></v8:item></Title><Action>ПроверитьУТМ</Action><CurrentRowUse>DontUse</CurrentRowUse></Command>' + [Environment]::NewLine +
                '    <Command name="ВыбратьТТН" id="7"><Title><v8:item><v8:lang>ru</v8:lang><v8:content>Выбрать ТТН</v8:content></v8:item></Title><Action>ВыбратьТТН</Action><CurrentRowUse>DontUse</CurrentRowUse></Command>' + [Environment]::NewLine
